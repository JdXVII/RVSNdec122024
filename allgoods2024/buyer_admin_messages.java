...
public class buyer_admin_messages extends AppCompatActivity {

    private static final int PICK_IMAGE_REQUEST = 1;
    private String senderId, receiverId = "admin"; // receiverId set to "admin"
    private EditText messageEditText;
    private RecyclerView messagesRecyclerView;
    private ImageView sendButton, attachImageView, selectedImageView;
    private ProgressBar progressBar;
    private BuyerAdminMessageAdapter buyerAdminMessageAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buyerAdminMessageAdapter = new BuyerAdminMessageAdapter(this, messagesList, senderId);
        messagesRecyclerView.setAdapter(buyerAdminMessageAdapter);
    ...
    private void fetchChatId() {
        ...
        chatsRef.orderByChild("users/senderId").equalTo(senderId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(buyer_admin_messages.this, "Failed to load chat", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void createNewChatAndSendMessage() {
        ...
        chatsRef.child(chatId).child("users").setValue(chat).addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                Toast.makeText(buyer_admin_messages.this, "Failed to create chat", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void uploadImage() {
        if (imageUri != null) {
            StorageReference storageRef = FirebaseStorage.getInstance().getReference("chat_buyer_images");
            ...
            imageRef.putFile(imageUri).addOnSuccessListener(taskSnapshot -> imageRef.getDownloadUrl().addOnSuccessListener(uri -> {
                ...
                progressBar.setVisibility(View.GONE);
                Toast.makeText(buyer_admin_messages.this, "Image upload failed", Toast.LENGTH_SHORT).show();
            });
        }
    }
    ...
    private void sendMessage(String imageUrl) {
        ...
        Message message = new Message(senderId, receiverId, "buyer", messageText, imageUrl, getCurrentTimestamp(), false);
        ...
        messagesRef.child(messageId).setValue(message).addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                Toast.makeText(buyer_admin_messages.this, "Failed to send message", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void fetchMessages() {
        ...
        messageEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                buyerAdminMessageAdapter.notifyDataSetChanged();
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(buyer_admin_messages.this, "Failed to load messages", Toast.LENGTH_SHORT).show();
            }
        };
