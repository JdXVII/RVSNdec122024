...
public class buyer_category extends AppCompatActivity {
    ...
    private BroadcastReceiver networkReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (isInternetAvailable(context)) {
                ...
                Toast.makeText(buyer_category.this, "No internet connection.", Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    private LinearLayout purchases, cart, messages, market;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messages.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent messages = new Intent(buyer_category.this, buyer_messages.class);
        ...
        market.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent market = new Intent(buyer_category.this, buyer_homepage.class);
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent cart = new Intent(buyer_category.this, buyer_addtocart.class);
                startActivity(cart);
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                finish();
            }
        ...
        purchases.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent purchases = new Intent(buyer_category.this, buyer_purchases.class);
        ...
        vendorRecyclerView.setAdapter(categoryAdapter);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if ("approved".equals(status)) {  // Check if the vendor's status is approved
                        String firstName = snapshot.child("firstName").getValue(String.class);
                        String lastName = snapshot.child("lastName").getValue(String.class);
                        String storeName = snapshot.child("storeName").getValue(String.class);
                        String userId = snapshot.child("userId").getValue(String.class); // Fetch userId
                        Category category = new Category(firstName, lastName, storeName, userId);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(buyer_category.this, "Failed to load vendor data. Please try again later.", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void checkForUnreadMessages() {
        ...
        chatsRef.addValueEventListener(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(buyer_category.this, "Failed to load messages", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent back = new Intent(buyer_category.this, buyer_homepage.class);
        startActivity(back);
