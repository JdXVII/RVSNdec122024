...
public class BuyerAdminMessageAdapter extends RecyclerView.Adapter<BuyerAdminMessageAdapter .MessageViewHolder> {
    ...
    public BuyerAdminMessageAdapter (Context context, List<Message> messagesList, String currentUserId) {
    ...
    public void onBindViewHolder(@NonNull MessageViewHolder holder, int position) {
        ...
        if ("admin".equals(message.getCategory())) {
        ...
        } else if ("buyer".equals(message.getCategory())) {
        ...
        buyersRef.child(buyerId).child("profileImageUrl").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (profileImageUrl != null) {
                    ...
                    profileImageView.setImageResource(R.drawable.logo); // Set a default image
                }
            }
