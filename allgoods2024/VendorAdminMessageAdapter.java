...
public class VendorAdminMessageAdapter extends RecyclerView.Adapter<VendorAdminMessageAdapter.MessageViewHolder> {
    ...
    public VendorAdminMessageAdapter(Context context, List<Message> messagesList, String currentUserId) {
