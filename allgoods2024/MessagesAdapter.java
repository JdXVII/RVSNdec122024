...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MessageViewHolder> {
    ...
    public MessageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.buyer_message_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull MessageViewHolder holder, int position) {
        ...
        if ("buyer".equals(message.getCategory())) {
            ...
            fetchVendorProfileImage(message.getReceiverId(), holder.profileImageView);
        }
        holder.messageContainer.setLayoutParams(params);

        // Set background color based on message category
        if ("buyer".equals(message.getCategory())) {
            holder.messageTextView.setBackgroundResource(R.drawable.message_bubble_green); // Define this drawable for buyer
            holder.messageTextView.setTextColor(android.graphics.Color.WHITE);
        } else if ("vendor".equals(message.getCategory())) {
            holder.messageTextView.setBackgroundResource(R.drawable.message_bubble_grey); // Define this drawable for vendor
    ...
    private void fetchVendorProfileImage(String vendorId, final ImageView profileImageView) {
        vendorsRef.child(vendorId).child("profileImageUrl").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
